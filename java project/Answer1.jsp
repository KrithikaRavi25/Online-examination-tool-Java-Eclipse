...
<body>
<body bgcolor ="pink">
<form name= "Answer1" action = "Examination2.jsp">
<br>
<br><br>
<center>
<font color="red" size = 12><b>YOUR ANSWER IS REGISTERED</b>
...
Connection con = null;
	 ...
	 out.println("correct ans");
			stmt=con.prepareStatement("select ans from cans where qid= '1'");
			rs=stmt.executeQuery();
			while(rs.next())
...
<form name= "Answer1" action = "Index.jsp">
